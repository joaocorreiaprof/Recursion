...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_fibs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/fibs.js */ \"./src/modules/fibs.js\");\n/* harmony import */ var _modules_fibsRec_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/fibsRec.js */ \"./src/modules/fibsRec.js\");\n/* harmony import */ var _modules_mergeSort_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/mergeSort.js */ \"./src/modules/mergeSort.js\");\n\n\n\n\n\nconst args = process.argv;\nif (args.length < 4) {\n  console.log(\n    \"Please provide a function (fibs, fibsRec, or mergeSort) and an argument (number for fibs/fibsRec or array for mergeSort)\"\n  );\n  process.exit(1);\n}\n\nconst funcName = args[2];\nconst input = args[3];\n\nlet result;\n\nif (funcName === \"fibs\" || funcName === \"fibsRec\") {\n  const number = parseInt(input, 10);\n  if (isNaN(number)) {\n    console.log(\"Invalid number provided\");\n    process.exit(1);\n  }\n\n  if (funcName === \"fibs\") {\n    result = (0,_modules_fibs_js__WEBPACK_IMPORTED_MODULE_1__.fibs)(number);\n  } else if (funcName === \"fibsRec\") {\n    result = (0,_modules_fibsRec_js__WEBPACK_IMPORTED_MODULE_2__.fibsRec)(number);\n  }\n  console.log(`Fibonacci sequence up to ${number} using ${funcName}:`, result);\n} else if (funcName === \"mergeSort\") {\n  let array;\n  try {\n    array = JSON.parse(input);\n    if (\n      !Array.isArray(array) ||\n      !array.every((item) => typeof item === \"number\")\n    ) {\n      throw new Error(\"Invalid array\");\n    }\n  } catch {\n    console.log(\n      \"Invalid array provided. Ensure it's a JSON array of numbers, e.g., [1,2,3]\"\n    );\n    process.exit(1);\n  }\n  result = (0,_modules_mergeSort_js__WEBPACK_IMPORTED_MODULE_3__.mergeSort)(array);\n  console.log(`Sorted array using mergeSort:`, result);\n} else {\n  console.log(\n    \"Invalid function name provided. Use 'fibs', 'fibsRec', or 'mergeSort'.\"\n  );\n  process.exit(1);\n}\n\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
